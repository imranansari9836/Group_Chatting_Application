...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        //for second image
         ...
         JLabel name=new JLabel("Imran Ansari");
    ...
    public static JPanel formatLabel(String out)
    {
        ...
        //Bording for padding
     //  output.setBounds(0, 0, 200, 20);
        output.setBorder(new EmptyBorder(15, 15,15,50));
          output.setBounds(0, 0, 250, 20);
    ...
    public static void main(String []args)
    {
        new Server();
        try{
            ServerSocket skt=new ServerSocket(6001);//port number hai 60001
            while(true)
            {
             Socket s= skt.accept();//Stored on socket socket me client se kuch v aata hai toh
